...
- **Formation** — The recommended set of roles (e.g. execution-lead, overseer, investigator-lead, planner-lead) with cardinality (min–max per role). The sitrep is generated by a sitrep-analyst or reused if less than 1 hour old.
