...
- **Parser** ([tools/taskgraph/src/plan-import/parser.ts](tools/taskgraph/src/plan-import/parser.ts)): Expects `TASK:`, `TITLE:`, `BLOCKED_BY:`, etc. — a different format.
- **Import command** ([tools/taskgraph/src/cli/import.ts](tools/taskgraph/src/cli/import.ts)): Calls `parsePlanMarkdown` then `upsertTasksAndEdges`. Plan creation and task upsert already work.
- **Importer** ([tools/taskgraph/src/plan-import/importer.ts](tools/taskgraph/src/plan-import/importer.ts)): Expects `ParsedTask` with `stableKey`, `title`, `blockedBy`, etc. Reusable as-is if parser produces that shape.
...
| File | Change |
|------|--------|
| [tools/taskgraph/src/plan-import/parser.ts](tools/taskgraph/src/plan-import/parser.ts) | Add `parseCursorPlan()` or format branch; export shared `ParsedPlan` / `ParsedTask` shape |
| [tools/taskgraph/src/cli/import.ts](tools/taskgraph/src/cli/import.ts) | Add `--format cursor` option; call Cursor parser when selected |
| [tools/taskgraph/package.json](tools/taskgraph/package.json) | Add `js-yaml` or similar if not present for YAML parsing |
| [AGENT.md](AGENT.md) | Add plan-review workflow and intent table |
| [tools/taskgraph/__tests__/plan-import/parser.test.ts](tools/taskgraph/__tests__/plan-import/parser.test.ts) | Add tests for Cursor format |
| New: `tools/taskgraph/__tests__/plan-import/cursor-format.test.ts` | Integration test: import real Cursor plan file |
