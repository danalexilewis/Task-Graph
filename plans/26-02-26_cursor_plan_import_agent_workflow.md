...
Existing plans (e.g. [26-02-26_task_graph_implementation_006e808b.md](26-02-26_task_graph_implementation_006e808b.md)) use `id`, `content`, `status`. No `blockedBy` in current files — infer from content (e.g. "blocked by m0-scaffold") or add optional support for future format.
