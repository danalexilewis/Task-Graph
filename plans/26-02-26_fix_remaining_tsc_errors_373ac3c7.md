...
- [src/cli/next.ts](src/cli/next.ts) line 18: validation error for invalid limit
- [src/cli/portfolio.ts](src/cli/portfolio.ts) line 40: validation error for invalid min count
- [src/cli/task.ts](src/cli/task.ts) line 38: validation error for invalid JSON
...
### 1. [src/cli/next.ts](src/cli/next.ts)
